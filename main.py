...
@app_commands.describe(
    message="The staff application requirements/information message.",
...
async def staffapply_slash(
    ...
    if not message.strip():
        await interaction.response.send_message("❌ Please provide the staff application requirements message.", ephemeral=True)
        return
