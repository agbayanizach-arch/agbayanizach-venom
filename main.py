...
class TicketControls(discord.ui.View):
    ...
    async def create_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            embed.set_footer(text="Ticket Tool • Close this ticket when your issue is resolved.")
...
class TicketConfigView(discord.ui.View):
    ...
    async def deploy(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed.set_footer(text="Ticket Tool • Private support tickets")
        view = TicketControls()
...
async def ticket_panel(interaction: discord.Interaction):
    ...
    embed.set_footer(text="Ticket Tool-style setup • Only administrators can configure this")
