...
class VouchTargetView(discord.ui.View):
    def __init__(self, owner_id: int):
        ...
        # Native Discord User Select: shows each user's real Discord profile/avatar.
        # Discord does not support filtering this menu to administrators only,
        # so the callback enforces the Administrator requirement before continuing.
    ...
    async def target_select(self, interaction: discord.Interaction):
        ...
        # Only administrators are allowed to be vouched for.
