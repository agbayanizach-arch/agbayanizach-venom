...
class VouchAdminSelect(discord.ui.Select):
    def __init__(self, owner_id: int, admins: list[discord.Member]):
...
class VouchTargetView(discord.ui.View):
    def __init__(self, owner_id: int, guild: discord.Guild):
        ...
        # Keep the real administrator profiles visible above the selector.
        self._profile_embeds = []
        for admin in admins[:25]:
            embed = discord.Embed(
